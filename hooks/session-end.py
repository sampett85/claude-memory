...
Reads the transcript, extracts conversation turns, spawns flush.py
as a background process. Does NO API calls — only local file I/O.
"""
...
def main() -> None:
    ...
    cmd = [
        "uv", "run", "--directory", str(MEMORY_ROOT),
