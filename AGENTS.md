...
### Digest Articles (`knowledge/digests/`)

Weekly summaries of daily logs. Generated by `digest.py`.

```markdown
---
title: "Week YYYY-WNN Digest"
type: digest
...
|   |-- connections/                 #   Cross-cutting insights linking 2+ concepts
|   |-- qa/                          #   Filed query answers (compounding knowledge)
|   |-- digests/                     #   Weekly summaries of daily logs
|-- scripts/                         # CLI tools
...
|   |-- sync.py                      #   Sync knowledge base to remote destinations
|   |-- digest.py                    #   Generate weekly digest summaries
